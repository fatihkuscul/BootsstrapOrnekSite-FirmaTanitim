...
<head>
    ...
    <title>Blog | Zorlu Translate</title>
</head>
...
<body>
    ...
    <header class="container mt-5">
        ...
        <div class="row mt-5">
            <h1 class="h1color1 col-12 text-center mt-3" id="advantage">BLOG HENÜZ KURULMADI</h1>

            <div class="col-12 col-md-6 iletisim-form mt-3">
                <img src="img/translate20.jpg" class="float-right" alt=" translate image" style="width: 100%;">
                <p class="text-center">
                    WordPress Kurulumu Sonrasında Yapılacaktır
                </p>
            </div>
