...
<body>
    ...
    <header class="container mt-5">
        ...
        <!-- GİZLİLİK SÖZLEŞMESİ Başlangıç  -->
        <div class="row">
            <div class="col-12">
                <h1 class="h1color1 col-12 text-center mt-3" id="advantage">GİZLİLİK SÖZLEŞMESİ</h1>
                <p class="metin">
                    İşbu Gizlilik Sözleşmesi, Zorlu Translate'in 
                    tüm kullanıcıları için 19.03.2021 tarihinden itibaren geçerli olup
                    çeviri anlaşması yapıldığında sözleşme imzalanması gerekmektedir.
                </p>
                <p class="metin">
                    Zorlu Translate olarak kişisel bilgilerin gizliliğinin muhafaza 
                    edilmesi bizim ilk önceliğimizdir. Temel amacımız, gizlilik 
                    ile ilgili uygulamalarımızın son kullanıcılar tarafından kolayca 
                    anlaşılabilir olmasıdır.
                </p>
            </div>

            <div class="col-12">
                <h2 class="font-weight-bold h1color3">Temel Gizlilik Kurallarımız;</h2>
                <ul>
                    <li class="metinLi mb-3">
                        Zorlu Translate, pazarlama aktivitelerinde kullanılması amacı ile kişisel bilgilerinizi üçüncü kişilere satmayacak ve kiralamayacaktır ve sadece Gizlilik Politikası’nda yer alan şartlar veya sizin açık rızanız doğrultusunda kişisel bilgiler paylaşılacaktır.
                    </li>
                    <li class="metinLi mb-3">
                        Zorlu Translate tarafından üçüncü kişi ve taraflara sağlanan bilgileriniz, sizin rızanız olmaksızın üçüncü kişi ve taraflarca herhangi bir şekilde satılmayacak, kiralanmayacak veya herhangi bir şekilde açıklanmayacaktır.
                    </li>
                    <li class="metinLi mb-3">
                        Kişisel bilgilerinizi, sitede size sunulan hizmetlerimizin daha iyi şekilde yürütülmesi amacı ile hizmet verecek olan dahili operasyon derpartmanlarımız ile veya gerektiğinde herhangi bir hizmetin sağlanması amacıyla gizlilik sözleşmesi çerçevesinde diğer sağlayıcılar ile paylaşabiliriz.
                    </li>
                    <li class="metinLi mb-3">
                        Kişisel bilgilerinizi Gizlilik Politikasına uygun olacak şekilde, site üzerinde gerçekleştirdiğiniz işlemlerinizin kolaylaştırılmasına yardımcı olmak ve diğer kullanıcıların sizinle daha kolay iletişime geçebilmesi amacıyla Zorlu Translate kullanıcıları ile paylaşabiliriz.
                    </li>
                    <li class="metinLi mb-3">
                        İdari kurumlar ve cezai soruşturma yürüten adli kurumlar tarafından gelen ve yasal geçerliliği olan talepler doğrultusunda bazı kişisel iletişim bilgilerinizi, Gizlilik Politikasına uygun olarak bu kurumlar ile paylaşılabiliriz.
                    </li>
                    <li class="metinLi mb-3">
                        Gizlilik Politikasının herhangi bir sebeple değişmesi halinde bu değişiklikleri sizlere elektronik posta yolu ile bildirecek ve de size söz konusu değişiklikleri reddetme imkanı sağlayacağız.
                    </li>
                    <li class="metinLi mb-3">
                        Kullanıcı hesabınızda yer alan kişisel bilgilerinizi üyelik panelimizden siz de güncelleyebilirsiniz.
                    </li>
                    <li class="metinLi mb-3">
                        Kişisel bilgilerin güvenliğinin sağlanması için, Zorlu Translate, SSL şifreleme yöntemi kullanılan sağlam ve güvenli bir teknoloji altyapısı kullanacaktır
                    </li>
                </ul>

            </div>
            <div class="col-12"></div>
        </div> <!-- GİZLİLİK SÖZLEŞMESİ sONU  -->
