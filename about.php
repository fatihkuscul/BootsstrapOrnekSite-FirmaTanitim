...
<head>
    ...
    <title>Hakkımızda | Zorlu Translate </title>
</head>
    ...
    <header class="container mt-5">
        ...
        <div class="row mb-5">
            <div class="col-lg-6 mt-3">
                <h1 class="font-weight-bold h1color3">
                    HAKKIMIZDA
                </h1>
                <p class="metin">
                    Zorlu Translate olarak bizler sahip olduğumuz "Mütercim-Tercümanlık" 
                    mesleğini en iyi ve en doğru şekilde sunabilmek için çalışmaktayız. 
                    Çözüm odaklı hizmet anlayışını ilke edinmiş olan profesyonel kadromuz 
                    ile sektörün önde gelen şirketleri arasında yer alıyoruz. 
                </p>

                <p class="metin">
                    Teknoloji ile entegre olmuş günümüz dünyasında, tercüme sektörüne 
                    dijitalleşmeyi de katarak sıradan olanın dışına çıkıyoruz.
                </p>

                <p class="metin">
                    Kaliteli çeviri ilkesini benimsemiş olan firmamız, profesyonel çeviriler
                    yapmakla kalmayıp kendi içinde sürekli bir kontrol mekanizması oluşturmuştur.
                </p>
                <form action="https://web.whatsapp.com/send?" method="get" target="_blank" class="mb-2">
                    <input type="text" name="phone" value="905057462404" hidden>
            ...
            <div class="col-lg-6">
                <img src="img/translate19.jpg" class="float-right mt-5" alt=" translate image" style="width: 100%;">
            </div>
        </div> <!-- Hakkımızda Bitiş  -->

        <div class="row">
            <div class="col-12">
                <h2 class="font-weight-bold h1color3">Neden Tercümanlık İçin Zorlu Translate</h2>
                <p class="metin">
                    Zorlu Translate, değişen ve dijitalleşen günümüz dünyası ile 
                    bir bütünlük içerisinde hizmet vermektedir. Dijitalleşmeyi 
                    yakalamış olan şirketimiz, sizler için güçlü bir teknolojik 
                    alt yapı ile birlikte çalışmaktadır. Yenilenmiş olan web 
                    sitemiz ile sizlere kesintisiz bir iletişim ve ulaşım imkanı 
                    sunmaktayız. 
                </p>
                <p class="metin">
                    Konya merkezli ofisinde tam zamanlı olarak hizmet veren Zorlu Translate
                    siz müşterilerimize online olarak tüm lokasyonlardan hizmet verebilmekteyiz.
                    Size bir tık veya bir telefon kadar uzağız.
                </p>
            </div>
            <div class="col-12">
                <h2 class="font-weight-bold h1color3">Vizyonumuz</h2>
                <p class="metin">                    
                    Zorlu Translate, her zaman daha da ileriye gitmeyi amaçlamaktadır. 
                    Şirketimiz içerisinde durağanlığa asla yer verilmemiş ve ekip 
                    olarak her koşulda daha iyi bir hizmet verebilmek birincil 
                    amacımız olmuştur. 
                </p>

                <p class="metin">
                    Her alanda yeniliklere açık olan şirketimiz, teknolojik gelişimlerin 
                    de sıkı bir takipçisi olmuştur. Dijitalleşmenin çeviri sektörüne 
                    etkilerini yakından gözlemliyor olan Zorlu Translate, bu gözlemler 
                    sonucunda kendini geliştirmekte ve yenilikçi bir bakış açısı ile 
                    "Daha iyisini nasıl verebiliriz?" sorusunun cevaplarını aramaktadır.
                </p>

                <p class="metin">
                    Şirketimizin bir diğer amacı da çözüm ortaklarının ihtiyaçlarını 
                    en kısa sürede cevaplayabilmektir. Bu amaç ile çalışmalar sürdürmekte 
                    ve kesintisiz bir iletişim için kendimizi geliştirmekteyiz
                </p>
